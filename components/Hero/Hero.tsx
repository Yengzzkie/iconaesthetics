...
const Hero = () => {
  return (
    <div className="relative flex items-center gap-4 text-(--primary) h-[calc(100vh-200px)]">
      {/* Background Image */}
      ...
      <div className="relative z-10 w-3/4 md:w-1/2 lg:w-1/3 ml-8 lg:ml-32">
        <h1 className={`${italiana.className} text-4xl text-shadow-[-3px_3px_7px_#11111185] lg:text-6xl`}>
          Reveal Your Natural Beauty
        </h1>
        <p className="font-thin text-shadow-[-3px_3px_7px_#11111170] my-4">
